...
این تابع عملیات اصلی محاسبه را انجام میدهد. به عنوان وروردی لیستی از همه فرشهارا دریافت میکند.
به طور خلاصه با استفاده از فرش های موجودی که در لیست آرایه ای carpets ذخیره شده وهمچنین پول دریافتی از
...
وLong minPrice = min(carpetsArr) و Carpet carpetWithMinPrice = getCarpet(minPrice,carpetsArr) یک حلقه به تعداد فرشها پیمایش میشود
اگر تعداد فرشها = n در نتیجه پیچیدگی این الگوریتم در بدترین حالت = O(n)
